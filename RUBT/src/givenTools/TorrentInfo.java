...
public class TorrentInfo {
	 ...
	 */
	public final static ByteBuffer KEY_LENGTH = ByteBuffer.wrap(new byte[] { 'l', 'e', 'n', 'g', 't', 'h' });

	/**
	 * Key used to retrieve the piece hashes.
	 */
	public final static ByteBuffer KEY_PIECES = ByteBuffer.wrap(new byte[] { 'p', 'i', 'e', 'c', 'e', 's' });
	...
	/**
	 * The unbencoded info dictionary of the torrent metainfo file.&nbsp; See
	 * <a href=
	 * "http://www.bittorrent.org/beps/bep_0003.html">http://www.bittorrent.org/beps/bep_0003.html</a>
	 * for an explanation of what keys are available and how they map.
	 */
